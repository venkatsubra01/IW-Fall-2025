...
\begin{itemize}
  \item Training and evaluation data used and why
  ...
  \item Filling in holes, acknowledging sensor error, diverse depth coverage
  \item FD sampling strategy
  \item Randomize fnumber, scaling, color jitter, random cropping
  \item Canonicalization 
  \item Design diagram (include canonicalization)
  \item Types of attention in play (temporal attention in motion module, spatial attention in DINO)
  \item Loss functions
